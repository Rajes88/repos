...
namespace StringExercises.App
{
    class Program
    {
        static void Main(string[] args)
        {
            Console.WriteLine("1.Convert from 1 to 10 amendments into a string array");
            Console.WriteLine("2.loop through the array and print each amendment");
            Console.WriteLine("3.find the amendments that contain 'Controversy");
            Console.WriteLine("4. what is the longest amendment");
